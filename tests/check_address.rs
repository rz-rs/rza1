...
gen! {
    registers = [
        ...
        // 11. OS Timer
        (OSTM0.ostmn_cmp, 0xFCFEC000 + 0x00),
        (OSTM0.ostmn_ts, 0xFCFEC000 + 0x14),
        (OSTM0.ostmn_ctl, 0xFCFEC000 + 0x20),
        (OSTM1.ostmn_cmp, 0xFCFEC400 + 0x00),
        (OSTM1.ostmn_ts, 0xFCFEC400 + 0x14),
        (OSTM1.ostmn_ctl, 0xFCFEC400 + 0x20),
        // 12. Watchdog Timer
        ...
        (RIIC0.riicn_cr1, 0xFCFEE000 + 0x0000),
        (RIIC0.riicn_sr2, 0xFCFEE000 + 0x0024),
        (RIIC0.riicn_drr, 0xFCFEE000 + 0x0040),
        (RIIC1.riicn_cr1, 0xFCFEE400 + 0x0000),
        (RIIC1.riicn_sr2, 0xFCFEE400 + 0x0024),
        (RIIC1.riicn_drr, 0xFCFEE400 + 0x0040),
        (RIIC2.riicn_cr1, 0xFCFEE800 + 0x0000),
        (RIIC2.riicn_sr2, 0xFCFEE800 + 0x0024),
        (RIIC2.riicn_drr, 0xFCFEE800 + 0x0040),
        (RIIC3.riicn_cr1, 0xFCFEEC00 + 0x0000),
        (RIIC3.riicn_sr2, 0xFCFEEC00 + 0x0024),
        (RIIC3.riicn_drr, 0xFCFEEC00 + 0x0040),
        ...
        // 27. A/D Converter
        (ADC.addra, 0xE8005800),
        (ADC.adcmpsr, 0xE8005864),
